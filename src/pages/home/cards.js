...
function Cards() {
  return (
    <div className="bg-[url('././assets/images/home-cards-bg.png')] bg-no-repeat bg-cover pb-[10%] pt-[35%]">
      <div className="grid grid-cols-1 md:grid-cols-2 justify-items-center gap-y-10 md:gap-y-20 px-4 md:px-0">
        <div className="bg-[#A4C8A1] p-[5%] relative rounded-[50px] w-full md:w-[80%]">
          ...
          />
          <p className="text-white text-base md:text-lg font-freeman text-justify absolute top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 w-[90%] md:w-[80%]">
